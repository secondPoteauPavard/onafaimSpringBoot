		...
		<div id="menuConnect">
			<form class="px-4 py-3">
				...
				<div class="form-group">
					...
					<input type="password" class="form-control" id="exampleDropdownFormPassword" placeholder="Saisir votre adresse mail">
				</div>
				
				<div class="form-group">
					<label for="exampleDropdownFormPassword1">Password</label>
					<input type="password" class="form-control" id="exampleDropdownFormEmail" placeholder="Saisir votre mot de passe">
				</div>
				...
				<button id="btnSubmit" type="submit" class="btn btn-secondary">S'inscrire</button>
			</form>
		</div>
	</div>
</div>
